                ...
                if (pokemonFilterPVP) {
                    ...
                    if (pokemonFilterPVP[idString]) {
                        ...
                        if (split.length === 2) {
                            ...
                            let greatLeague = filtered.pvp_rankings_great_league ? filtered.pvp_rankings_great_league.filter(x => x.rank > 0 && x.rank >= minRank && x.rank <= maxRank && x.cp >= 1400 && x.cp <= 1500) : [];
                            let ultraLeague = filtered.pvp_rankings_ultra_league ? filtered.pvp_rankings_ultra_league.filter(x => x.rank > 0 && x.rank >= minRank && x.rank <= maxRank && x.cp >= 2400 && x.cp <= 2500) : [];
